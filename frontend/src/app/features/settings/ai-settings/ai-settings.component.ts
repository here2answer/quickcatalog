  ...
  template: `
    <div class="p-6 lg:p-8 max-w-3xl mx-auto">
      ...
      <div class="flex items-center gap-4 mb-6">
        <a routerLink="/settings" class="p-2 rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-100">
        ...
        <div>
          ...
          <p class="text-sm text-gray-500 mt-0.5">Configure AI-powered content generation</p>
        </div>
      </div>
